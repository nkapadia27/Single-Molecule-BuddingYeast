...
#replisome radius are only calculated from initial conditions not throughout time
        ...
        for D_rep in sim_array_D_rep:
            for D in sim_array_D:
                ...
                Timelapse_name =  "Rep" + str(num_replisomes) + "_" + "Excess" + \
                                  ...
                                  "BD_Frac"+ str(bound_frac) + "Time_step" + str(dt) + "Tbind" + str(Tbind) + "alpha" + str(alpha_d)
                #BD_state = 0
                ...
                for k in range(num_simulations):
                    ...
                    BF_freq = BF_end_ele + 1 #total track duration including gaps
