...
Data_frame = Data_frame.melt(var_name='Protein', value_name='Diffusion Coefficients $(um^2/s)$')
#print(Data_frame)
#fig, ax = mtl.subplots()
ax = sns.boxplot(x="Protein", y="Diffusion Coefficients $(um^2/s)$", data=Data_frame)
ax = sns.swarmplot(x="Protein", y="Diffusion Coefficients $(um^2/s)$", data=Data_frame, color=".25")
#mtl.legend()
