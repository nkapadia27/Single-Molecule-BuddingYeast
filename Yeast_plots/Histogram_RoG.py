...
#Load Pol3
POL32_load = sio.loadmat(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Diffusion Plots\POL32_ROG_TOTAL.mat")
...
#H3 Histone
Histone_load_tr = sio.loadmat(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Diffusion Plots\YTK1434_ROG_TOTAL_Training.mat")
...
print(Data_frame)
#fig, ax = mtl.subplots()
sns.distplot( POL32_dat, color="blue",label = 'POL32 Prediction', kde = False, norm_hist = True)
sns.distplot( Histone_dat_tr, color="red", label = 'Histone H3 Training', kde = False, norm_hist = True)
sns.distplot( Histone_dat_exp, color="green", label = 'Histone H3 Prediction', kde = False, norm_hist = True)
mtl.legend()
...
mtl.savefig(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Diffusion Plots\RoG Comparison.ps")
#ax2 = ax.twinx()
