...
#Load DPB4
DPB4_load = sio.loadmat(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\20s\DPB4.mat")
...
#H3 Histone
Histone_load = sio.loadmat(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\20s\YTK1434.mat")
...
Data_total = pd.concat([CDC_dat,DPB4_dat,POL3_dat, POL32_dat, Histone_dat], axis = 1)
Data_total = npy.array(Data_total)
Data_frame = pd.DataFrame(Data_total, columns=['CDC45','DPB4','POL3','POL32','Histone H3'])
...
mtl.savefig(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\20s\Violin Comparison_20s.ps")
#ax2 = ax.twinx()
