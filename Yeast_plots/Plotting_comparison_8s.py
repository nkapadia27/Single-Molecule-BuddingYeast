...
#Load CDC45
CDC_load = sio.loadmat(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\8s\CDC45.mat")
...
#Load DPB4
DPB4_load = sio.loadmat(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\8s\DPB4.mat")
...
#Load Pol32
POL32_load = sio.loadmat(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\8s\POL32.mat")
...
#H3 Histone
Histone_load = sio.loadmat(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\8s\YTK1434.mat")
...
Data_total = pd.concat([CDC_dat,DPB4_dat,POL32_dat,POL12_dat, CTF4_dat, Histone_dat], axis = 1)
Data_total = npy.array(Data_total)
Data_frame = pd.DataFrame(Data_total, columns=['CDC45','DPB4','POL32', 'POL12', 'CTF4', 'Histone H3'])
...
mtl.savefig(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\1s\Violin Comparison_8s_test.ps")
#ax2 = ax.twinx()
