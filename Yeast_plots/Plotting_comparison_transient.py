...
#Load DPB4
TOP2_load = sio.loadmat(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\1s\TOP2.mat")
TOP2_dat = TOP2_load["On_time_combined"]
TOP2_dat = npy.array(TOP2_dat)
...
TOP2_dat = pd.DataFrame(TOP2_dat)
...
Data_total = pd.concat([TOP2_dat, Histone_dat], axis = 1)
Data_total = npy.array(Data_total)
Data_frame = pd.DataFrame(Data_total, columns=['TOP2','Histone H3'])
...
mtl.savefig(r"C:\Users\Reyes-Lamothe Lab\Pictures\Microscopy Data\Nitin\PALM Yeast\Track Durations Combined\1s\Violin Comparison_1s_Transient.ps")
#ax2 = ax.twinx()
